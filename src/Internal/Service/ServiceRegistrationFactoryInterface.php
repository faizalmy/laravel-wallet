...
/**
 * Interface for service registration factories.
 *
 * This interface provides a common contract for different types of service registration
 * factories, allowing for clean separation of concerns in the service provider.
 */
interface ServiceRegistrationFactoryInterface
{
    /**
